...
const receiveSearchHistory = (suggestionTermObj) => ({
...
export const setSearchHistory = (suggestion, term) => (dispatch) => {
	...
	if (!includes) {
		localStorage.setItem(
			"searchHistory",
			JSON.stringify([...localStorageSearchHistory, { suggestion, term }])
		);
		dispatch(receiveSearchHistory({ suggestion, term }));
	}
};
